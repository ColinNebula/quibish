...
// Import prop types
import {
  HomeComponentPropTypes,
  HomeComponentDefaultProps,
  AppHeaderPropTypes,
  AppSidebarPropTypes,
  StatusBarPropTypes,
  MessageListPropTypes,
  MessageItemPropTypes,
  MessageItemDefaultProps,
  InputAreaPropTypes,
  InputAreaDefaultProps,
  EmptyStatePropTypes,
  EmptyStateDefaultProps,
  EmojiPickerPropTypes,
...
const HomeComponent = ({ user, onLogout }) => {
  ...
  useEffect(() => {
    ...
    if (!isMobile) {
      const input = document.querySelector('.elegant-message-input');
      if (input) {
        input.focus();
      }
    }
    ...
    <div className="input-area">
      ...
      <div className="input-bar">
        <div className="input-wrapper">
          <textarea
            className="elegant-message-input"
...
HomeComponent.propTypes = HomeComponentPropTypes;
HomeComponent.defaultProps = HomeComponentDefaultProps;
...
MessageItem.defaultProps = MessageItemDefaultProps;
InputArea.propTypes = InputAreaPropTypes;
InputArea.defaultProps = InputAreaDefaultProps;
EmptyState.propTypes = EmptyStatePropTypes;
EmptyState.defaultProps = EmptyStateDefaultProps;
EmojiPicker.propTypes = EmojiPickerPropTypes;
StatusModal.propTypes = StatusModalPropTypes;